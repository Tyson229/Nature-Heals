...
@section('content')
    <main class="flex-fill bg-light" >
        ...
        <div class="container mt-5">
            ...
            <h1 class="display-5 mt-3 mb-4">Our Team</h1>
                ...
                <div class="col">
                    <div class="card border rounded-3 shadow-sm" style="background-color: #96c0b7;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Dr Nicole Peel is a Lecturer in Recreational Therapy at Western Sydney University, and an expert in leisure, wellbeing and inclusion. Dr Peel is an avid cyclist, bushwalker and is most at home in any outdoor recreation environment where she passionately supports sustainable practice. 
                            </p>
                        </div>
                    </div> 
                </div>
                    ...
                    <div class="card border rounded-3 shadow-sm" style="background-color: #7fcaba;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text mb-4">
                                Dr Arianne Reis is a Senior Lecturer in Leisure and Recreation Studies at Western Sydney University, and an expert in leisure and wellbeing. Dr Reis is an avid bushwalker and (probably soon retiring!) rock climber and passionate about being outdoor.
                            </p>
