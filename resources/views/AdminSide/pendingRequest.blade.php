...
@section('content')
    <main>
        ...
        <div class="row mb-2">
            ...
            <!--Search Bar-->
            <div class="col-sm-5">
                <form action="/login/request" method="GET" role="search">
            ...
            <table class="table table-hover">
                <thead class="table-dark">
                    <tr>
                        ...
                        <th scope="col" class="align-middle">Requestor</th>
                        <th scope="col" class="align-middle">Internal Request</th>
                                        ...
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                <div class="modal-header bg-dark">
                                                    <h1 class="text-white">Current Request</h1>
                                                ...
                                                <form action="/login/request/{{ $tool->tool_ID }}" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="container bg-white">
                                                                ...
                                                                <div class="main">
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <div class="col-sm-2">
                                                                            <label for="adminRequestorSource" class="col-form-label">Requestor's role</label>
                                                                        </div>
                                                                        <div class="col">
                                                                            @if($tool->internal_request==1)
                                                                                <input id="adminRequestorSource" class="form-control" value="Admin" disabled>        
                                                                            @else
                                                                                <input id="adminRequestorSource" class="form-control" value="Visitor" disabled>
                                                                            @endif          
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row mb-3">     
                                                                        ...
                                                                        <div class="col-sm-10" id="retrieved_studies-{{ $tool->tool_ID }}">
                                                                            ...
                                                                            @foreach ($link_lists as $link)
                                                                                    @if($link->id == $tool->tool_ID)
                                                                                        ...
                                                                                        @if ($counter_link == 1)
                                                                                            <div class="row mb-2" >
                                                                                                <div class="col-sm-6">
                                                                                                    <input name="requestStudyLabel-{{ $tool->tool_ID }}" class="form-control" value="{{ $link->study_name }}" placeholder="Article title">
                                                                                                </div>
                                                                                                <div class="col-sm-4">
                                                                                                    <input name="requestLinkLabel-{{ $tool->tool_ID }}" class="form-control" value="{{ $link->link }}" placeholder="Upload your link here...">
                                                                                                </div>
                                                                                                <div class="col-sm-1">
                                                                                        ...
                                                                                        @else
                                                                                            <div class="row mb-2" id="requestMore_{{ $counter_link }}_{{ $tool->tool_ID }}">
                                                                                                <div class="col-sm-6">
                                                                                                    <input name="requestMoreStudyLabel-{{ $tool->tool_ID }}[]" class="form-control" value="{{ $link->study_name }}" placeholder="Article title">
                                                                                                </div>
                                                                                                <div class="col-sm-4">
                                                                                                    <input name="requestMoreLinkLabel-{{ $tool->tool_ID }}[]" class="form-control" value="{{ $link->link }}" placeholder="Upload your link here...">
                                                                                                </div>
                                                                                                <div class="col-sm-1">
                                                                            ...
                                                                            <div class="row mb-2" >
                                                                                <div class="col-sm-6">
                                                                                    <input  name="requestStudyLabel-{{ $tool->tool_ID }}" class="form-control" placeholder="Type the study name" placeholder="Article title">
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                    <input name="requestLinkLabel-{{ $tool->tool_ID }}" class="form-control" placeholder="Upload the link here..." placeholder="Upload your link here...">
                                                                                </div>
                                                                                <div class="col-sm-1">
                                                                            ...
                                                                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" >
                                                                                <div class="accordion-body">
                                                                                    ...
                                                                                    <div class="row mb-3">
                                                                                        ...
                                                                                        <div class="col-sm-3">
                                                                                            <select name="requestReliability" class="form-select">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" name="decline" value="Submit" class="btn btn-danger me-auto">Decline</button>
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="window.location.reload();">Cancel</button>
                                                        
                                                        <button type="submit" name="approve" value="Submit" class="btn btn-success">Approve</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
